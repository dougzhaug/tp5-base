        ...
        function makeLeftMenu($arr){
            ...
            foreach ($arr as $val){
                if(empty($val['children'])){
                    $html .= '<li class="left-nav-li" id="nav-'.$val['id'].'"><a href="'. url($val['Url']) .'"><i class="fa ' . $val["rel"] . '"></i><span> '.$val["Name"].' </span></a></li>';
                }else{
                    $html .= '<li class="treeview"><a href="' . url($val['Url']) . '"><i class="fa ' . $val["rel"] . '"></i> <span>' . $val['Name'] . '</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>';
